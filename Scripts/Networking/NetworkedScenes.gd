...
func match_id_to_scene(id: NetworkedIds.Scene) -> Resource:
	match id:
		...
		NetworkedIds.Scene.FOOD_DIRT: return load("res://Scenes/foot_dirt.tscn")
		NetworkedIds.Scene.STEAK: return load("res://Scenes/foods/steak.tscn")
		...
		NetworkedIds.Scene.DRINK_FOUNTAIN: return load("res://Scenes/drink_fountain.tscn")
		
		NetworkedIds.Scene.TABLE_FOUR: return load("res://Scenes/furniture/four_person_table.tscn")
		NetworkedIds.Scene.BELL: return load("res://Scenes/bell.tscn")
		...
		NetworkedIds.Scene.PLAYER_PING: return load("res://Scenes/ping.tscn")
